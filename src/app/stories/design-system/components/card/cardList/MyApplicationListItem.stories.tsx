...
const mockProps = {
  ...
  form: {
    ...
    description:
      "스타벅스 강남점에서 함께할 파트타이머를 모집합니다. 주말 ��무 가능자 우대, 경력자 우대, 장기 근무자 우대",
...
export const LongDescription: Story = {
  args: {
    ...
    form: {
      ...mockProps.form,
      description:
        "스타벅스 강남점에서 함께할 파트타이머를 모집합니다. 주말 근무 가능자 우대, 경력자 우대, 장기 근무자 우대. 스타벅스 ���남점에서 함께할 파트타이머를 모집합니다. 주말 근무 가능자 우대, 경력자 우대, 장기 근무자 우대.",
    },
  },
};
