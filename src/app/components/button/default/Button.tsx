...
const Button = ({
  ...
  const colorStyles = {
    orange: {
      solid:
        "bg-primary-orange-300 text-white hover:bg-primary-orange-450 focus:ring-1 focus:ring-primary-orange-200 focus:outline-none disabled:bg-primary-orange-100 disabled:cursor-not-allowed",
      outlined:
    ...
    lime: {
      solid:
        "bg-primary-orange-300 text-white hover:bg-primary-orange-400 focus:ring-1 focus:ring-primary-orange-200 focus:outline-none disabled:bg-primary-orange-100 disabled:cursor-not-allowed",
      outlined:
