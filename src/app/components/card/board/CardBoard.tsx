  ...
  return (
    <div
      className={`flex flex-col rounded-[16px] border p-4 ${
        variant === "primary" ? "border-primary-orange-100 bg-primary-orange-50" : "bg-grayscale-50 border-line-100"
    ...
    >
      ...
      <div className="flex h-[162px] w-[279px] flex-1 flex-col sm:h-[232px] sm:w-[429px]">
        ...
        {/* Content */}
        <p className="text-grayscale-500 line-clamp-2 font-nexon text-[14px] font-normal leading-[1.5] sm:text-[16px]">
          {content}
        </p>
      </div>
      ...
      <div className="mt-4 flex h-[24px] w-[279px] items-center justify-between sm:h-[36px] sm:w-[429px]">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1 truncate">
            <span className="text-grayscale-500 truncate font-nexon text-[14px] font-normal sm:text-[16px]">
              {userName}
            </span>
            <span className="text-grayscale-500">|</span>
            <span className="text-grayscale-500 whitespace-nowrap font-nexon text-[14px] font-normal sm:text-[16px]">
              {date}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
          ...
          <div className="flex items-center gap-1">
            <Image
              ...
              height={22}
            />
            <span className="text-grayscale-500 font-nexon text-[14px] font-normal sm:text-[16px]">{comments}</span>
          </div>
          {/* 좋아요 */}
          <div className="flex items-center gap-1">
            <Image
            ...
            />
            <span className="text-grayscale-500 font-nexon text-[14px] font-normal sm:text-[16px]">{likeCount}</span>
          </div>
        </div>
      </div>
    </div>
