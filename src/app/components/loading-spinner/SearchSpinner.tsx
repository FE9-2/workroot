...
export default function SearchSpinner() {
  return (
    <div className="absolute z-50 flex w-full flex-col items-center justify-center bg-white px-4">
      <Player autoplay loop src="/search.json" className="mb-8 h-[50vh] w-full max-w-[300px] lg:max-w-[500px]" />
