...
export default function LoadingSpinner() {
  return (
    <div className="absolute left-1/2 top-1/2 flex min-h-screen w-[calc(100vh-8px)] -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center bg-white px-4">
      <Player
        autoplay
        loop
        src="/loding.json"
