try {
  (() => {
    ...
    var K = { type: "item", value: "" },
      Y = (o, t) => ({
        ...
        toolbar: {
          ...
          items: t.toolbar.items.map((e) => {
            ...
            return (
              r.type === "reset" && t.toolbar.icon && ((r.icon = t.toolbar.icon), (r.hideIcon = !0)), { ...K, ...r }
            );
          }),
        },
      }),
      ...
      F = ({ currentValue: o, items: t }) => o != null && t.find((e) => e.value === o && e.type !== "reset"),
      ...
      Q = ({ right: o, title: t, value: e, icon: r, hideIcon: a, onClick: c, disabled: T, currentValue: i }) => {
        let n = r && l.createElement(A, { style: { opacity: 1 }, icon: r }),
      ...
      X = U(
        ({
          ...
          return l.createElement(
            ...
            l.createElement(J, { active: I || m, disabled: d, description: e || "", icon: p, title: b || "" })
          );
        }
      ),
      ee = () => {
    ...
    k.register(S, () =>
      k.add(S, { title: S, type: M.TOOL, match: ({ tabId: o }) => !o, render: () => l.createElement(ee, null) })
    );
  })();
} catch (e) {
