    ...
    var uo = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
      ...
      bn = (e, t, n, r) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let i of so(t))
            !co.call(e, i) && i !== n && wt(e, i, { get: () => t[i], enumerable: !(r = ao(t, i)) || r.enumerable });
        return e;
      };
    var po = (e, t, n) => (
        (n = e != null ? io(lo(e)) : {}),
      ...
      Tn = ye(() => {
        ...
        (dl = __STORYBOOK_CORE_EVENTS__),
          ({
            ...
            GLOBALS_UPDATED: Rl,
            NAVIGATE_URL: _l,
            PLAY_FUNCTION_THREW_EXCEPTION: xl,
            PRELOAD_ENTRIES: Al,
            PREVIEW_BUILDER_PROGRESS: Nl,
            PREVIEW_KEYDOWN: kl,
            REGISTER_SUBSCRIPTION: Ml,
            REQUEST_WHATS_NEW_DATA: jl,
            RESET_STORY_ARGS: Ll,
            ...
            STORIES_EXPAND_ALL: Ql,
            STORY_ARGS_UPDATED: Jl,
            STORY_CHANGED: Xl,
            STORY_ERRORED: Zl,
            ...
            STORY_UNCHANGED: ac,
            TELEMETRY_ERROR: sc,
            TESTING_MODULE_CANCEL_TEST_RUN_REQUEST: lc,
            TESTING_MODULE_CANCEL_TEST_RUN_RESPONSE: cc,
            TESTING_MODULE_CRASH_REPORT: uc,
            TESTING_MODULE_PROGRESS_REPORT: pc,
            TESTING_MODULE_RUN_ALL_REQUEST: fc,
            TESTING_MODULE_RUN_REQUEST: dc,
            TESTING_MODULE_WATCH_MODE_REQUEST: hc,
            TOGGLE_WHATS_NEW_NOTIFICATIONS: yc,
            UNHANDLED_ERRORS_WHILE_PLAYING: mc,
            UPDATE_GLOBALS: gc,
            UPDATE_QUERY_PARAMS: bc,
            UPDATE_STORY_ARGS: vc,
      ...
      Rn = ye(() => {
        ...
        (pu = __STORYBOOK_COMPONENTS__),
          ({
            ...
            codeCommon: yp,
            components: mp,
            createCopyToClipboardFunction: gp,
            getStoryHref: bp,
            icons: vp,
            interleaveSeparators: Ep,
            nameSpaceClassNames: Op,
            resetComponents: wp,
            withReset: Sp,
        ...
        return (function (t) {
                ...
                return (
                  ...
                  o === 0
                    ...
                    : (o /= l) == 1
                      ? a + f
                      : ((p = 0) || (p = 0.3 * l),
                        (c = f) < Math.abs(f) ? ((c = f), (u = p / 4)) : (u = (p / (2 * Math.PI)) * Math.asin(f / c)),
                        -c * Math.pow(2, 10 * (o -= 1)) * Math.sin(((o * l - u) * (2 * Math.PI)) / p) + a)
                );
              },
                ...
                return (
                  ...
                  o === 0
                    ...
                    : (o /= l) == 1
                      ...
                      : ((p = 0) || (p = 0.3 * l),
                        (c = f) < Math.abs(f) ? ((c = f), (u = p / 4)) : (u = (p / (2 * Math.PI)) * Math.asin(f / c)),
                        c * Math.pow(2, -10 * o) * Math.sin(((o * l - u) * (2 * Math.PI)) / p) + f + a)
                );
              },
                  ...
                  o === 0
                    ...
                    : (o /= l / 2) == 2
                      ...
                      : ((p = 0) || (p = l * 0.44999999999999996),
                        (c = f) < Math.abs(f) ? ((c = f), (u = p / 4)) : (u = (p / (2 * Math.PI)) * Math.asin(f / c)),
                        o < 1
                          ? c * Math.pow(2, 10 * (o -= 1)) * Math.sin(((o * l - u) * (2 * Math.PI)) / p) * -0.5 + a
                          : c * Math.pow(2, -10 * (o -= 1)) * Math.sin(((o * l - u) * (2 * Math.PI)) / p) * 0.5 + f + a)
                );
              },
          ...
          function (t, n, r) {
            ...
            function f(d, h, g) {
              return (
                h in d
                  ? Object.defineProperty(d, h, { value: g, enumerable: !0, configurable: !0, writable: !0 })
                  : (d[h] = g),
                d
              );
            }
            ...
            var b = (function () {
              function d(N, j, w, O) {
                ...
                (this.context = N),
                  ...
                  (this.color = _e[Math.floor(Math.random() * _e.length)]),
                  (this.rotateY = p(0, 1)),
            ...
            var T = function d(h, g) {
              var y = this;
              (function (j, w) {
                if (!(j instanceof w)) throw new TypeError("Cannot call a class as a function");
              })(this, d),
                ...
                m(this, "removeParticleAt", function (j) {
                  y.particles.splice(j, 1);
                }),
                m(this, "getParticle", function () {
                  var j = p(y.x, y.w + y.x),
                    w = p(y.y, y.h + y.y);
                  return new b(y.context, y.getOptions, j, w);
                }),
                m(this, "animate", function () {
                  ...
                  return (
                    Ge &&
                      ...
                      (w.fillStyle = "#333"),
                      (w.textAlign = "right"),
                      w.fillText("Particles: ".concat(Ft), j.width - 10, j.height - 20)),
                    y.particles.forEach(function (ot, mn) {
                      ot.update(),
                        (ot.y > j.height || ot.y < -100 || ot.x > j.width + 100 || ot.x < -100) &&
                          (_e && rt <= ie ? (y.particles[mn] = y.getParticle()) : y.removeParticleAt(mn));
                    }),
                    Ft > 0 || rt < ie
                  );
                }),
              ...
              (this.context = N), (this.getOptions = g);
            };
            function F(d, h) {
              var g = Object.keys(d);
                  ...
                  (function (U, z) {
                    ...
                    v(this, "update", function () {
                      var U = w.options,
                        ...
                        _e = w.canvas,
                        ie = w.context;
                      z && ((ie.fillStyle = "white"), ie.clearRect(0, 0, _e.width, _e.height)),
                        w.generator.animate()
                          ? (w.rafId = requestAnimationFrame(w.update))
                          : (ne && typeof ne == "function" && w.generator.particlesGenerated > 0 && ne.call(w, w),
                            (w._options.run = !1));
                    }),
                    ...
                    v(this, "stop", function () {
                      (w.options = { run: !1 }), w.rafId && (cancelAnimationFrame(w.rafId), (w.rafId = void 0));
                    }),
                    (this.canvas = N);
                  ...
                  (g = [
                    {
                      ...
                      set: function (N) {
                        ...
                        this.setOptionsWithDefaults(N),
                          ...
                          typeof N.run == "boolean" && N.run && j === !1 && this.update();
                      },
                    },
                  ]) && _(h.prototype, g),
                  y && _(h, y),
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function se(d) {
              for (var h = 1; h < arguments.length; h++) {
                var g = arguments[h] != null ? arguments[h] : {};
                h % 2
                  ? Q(Object(g), !0).forEach(function (y) {
                      we(d, y, g[y]);
                    })
                  : Object.getOwnPropertyDescriptors
                    ? Object.defineProperties(d, Object.getOwnPropertyDescriptors(g))
                    : Q(Object(g)).forEach(function (y) {
                        Object.defineProperty(d, y, Object.getOwnPropertyDescriptor(g, y));
                      });
              }
              return d;
                  ...
                  if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(g)))) {
                    ...
                    try {
                      for (
                        ...
                        !(j = (U = z.next()).done) && (N.push(U.value), !y || N.length !== y);
                        j = !0
                      );
                    } catch (ne) {
                      (w = !0), (O = ne);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function tt(d) {
              ...
              return function () {
                ...
                if (h) {
                  ...
                  g = Reflect.construct(y, arguments, N);
            ...
            var S = s.a.createRef(),
              k = (function (d) {
                ...
                function j(w) {
                  var O;
                  et(this, j);
                  for (var U = arguments.length, z = new Array(U > 1 ? U - 1 : 0), ne = 1; ne < U; ne++)
                    z[ne - 1] = arguments[ne];
                  return (
                    we(fe((O = N.call.apply(N, [this, w].concat(z)))), "canvas", s.a.createRef()),
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return s.a.createElement(
                          "canvas",
                          te({ width: O.width, height: O.height, ref: this.canvas }, U, { style: z })
                        );
                      },
                    },
                  ]) && He(h.prototype, g),
            ...
            function H(d) {
              var h = {},
                g = {},
                y = [].concat(K(Object.keys(P)), ["confettiSource", "drawShape", "onConfettiComplete"]),
                N = ["canvasRef"];
              for (var j in d) {
                var w = d[j];
                y.includes(j) ? (h[j] = w) : N.includes(j) ? (N[j] = w) : (g[j] = w);
              }
              return [h, g, {}];
            }
            we(k, "defaultProps", se({}, P)), we(k, "displayName", "ReactConfetti");
            var G = s.a.forwardRef(function (d, h) {
              return s.a.createElement(k, te({ canvasRef: h }, d));
            });
            n.default = G;
          },
        ]).default;
    ...
    var Zp,
      ...
      jn = ye(() => {
        ...
        X();
        Z();
        (Zp = __STORYBOOK_ICONS__),
          ({
            AccessibilityAltIcon: ef,
            AccessibilityIcon: tf,
            AddIcon: nf,
            AdminIcon: rf,
            AlertAltIcon: of,
            AlertIcon: af,
            ...
            AlignRightIcon: lf,
            AppleIcon: cf,
            ArrowBottomLeftIcon: uf,
            ArrowBottomRightIcon: pf,
            ArrowDownIcon: ff,
            ArrowLeftIcon: df,
            ArrowRightIcon: kn,
            ArrowSolidDownIcon: hf,
            ArrowSolidLeftIcon: yf,
            ArrowSolidRightIcon: mf,
            ArrowSolidUpIcon: gf,
            ArrowTopLeftIcon: bf,
            ArrowTopRightIcon: vf,
            ArrowUpIcon: Ef,
            AzureDevOpsIcon: Of,
            BackIcon: wf,
            BasketIcon: Sf,
            ...
            ChevronLeftIcon: Vf,
            ChevronRightIcon: Kf,
            ChevronSmallDownIcon: Qf,
            ChevronSmallLeftIcon: Jf,
            ChevronSmallRightIcon: Xf,
            ChevronSmallUpIcon: Zf,
            ChevronUpIcon: ed,
            ChromaticIcon: td,
            ChromeIcon: nd,
            CircleHollowIcon: rd,
            ...
            PinAltIcon: $h,
            PinIcon: Vh,
            PlayAllHollowIcon: Kh,
            PlayBackIcon: Qh,
            PlayHollowIcon: Jh,
            PlayIcon: Xh,
            PlayNextIcon: Zh,
            PlusIcon: ey,
            PointerDefaultIcon: ty,
            PointerHandIcon: ny,
            PowerIcon: ry,
            PrintIcon: oy,
            ProceedIcon: iy,
            ...
            SideBySideIcon: Sy,
            SidebarAltIcon: Ty,
            SidebarAltToggleIcon: Iy,
            SidebarIcon: Cy,
            SidebarToggleIcon: Py,
            SpeakerIcon: Ry,
            StackedIcon: _y,
            StarHollowIcon: xy,
            StarIcon: Ay,
      ...
      return (
        ...
        it(
          E.createElement(
            ...
            E.createElement(hr.default, { colors: i, drawShape: ni, ...o })
          ),
          a
        )
      );
    ...
    function x(e) {
      ...
      return x.array(e) ? "Array" : x.plainFunction(e) ? "Function" : kt(e) || "Object";
    }
    function yi(...e) {
      return e.every((t) => M.string(t) || M.array(t) || M.plainObject(t));
    }
    function mi(e, t, n) {
      return Or(e, t)
        ? [e, t].every(M.array)
          ? !e.some(zn(n)) && t.some(zn(n))
          : [e, t].every(M.plainObject)
            ? !Object.entries(e).some(Gn(n)) && Object.entries(t).some(Gn(n))
            : t === n
        : !1;
    }
    function Wn(e, t, n) {
      let { actual: r, key: i, previous: o, type: a } = n,
        s = Te(e, i),
        l = Te(t, i),
        c = [s, l].every(M.number) && (a === "increased" ? s < l : s > l);
      return M.undefined(r) || (c = c && l === r), M.undefined(o) || (c = c && s === o), c;
    }
    function Un(e, t, n) {
      let { key: r, type: i, value: o } = n,
        ...
        l = i === "added" ? a : s,
        c = i === "added" ? s : a;
      if (!M.nullOrUndefined(o)) {
        if (M.defined(l)) {
          if (M.array(l) || M.plainObject(l)) return mi(l, c, o);
        } else return ae(c, o);
        return !1;
      }
      return [a, s].every(M.array)
        ? !c.every(on(l))
        : [a, s].every(M.plainObject)
          ? gi(Object.keys(l), Object.keys(c))
          : ![a, s].every((p) => M.primitive(p) && M.defined(p)) &&
            (i === "added" ? !M.defined(a) && M.defined(s) : M.defined(a) && !M.defined(s));
    }
    function Hn(e, t, { key: n } = {}) {
      ...
      return [r, i].every(M.plainObject) && ((r = Object.keys(r)), (i = Object.keys(i))), [r, i];
    }
    function Gn(e) {
      return ([t, n]) =>
        M.array(e)
          ? ae(e, n) || e.some((r) => ae(r, n) || (M.array(n) && on(n)(r)))
          : M.plainObject(e) && e[t]
            ? !!e[t] && ae(e[t], n)
            : ae(e, n);
    }
    ...
    function zn(e) {
      return (t) => (M.array(e) ? e.some((n) => ae(n, t) || (M.array(t) && on(t)(n))) : ae(e, t));
    }
    function lt(e, t) {
      return M.array(e) ? e.some((n) => ae(n, t)) : ae(e, t);
    }
    function on(e) {
    ...
    function Te(e, t) {
      return M.plainObject(e) || M.array(e)
        ? M.string(t)
    ...
    function _t(e, t) {
      if ([e, t].some(M.nullOrUndefined)) throw new Error("Missing required parameters");
      if (![e, t].every((n) => M.plainObject(n) || M.array(n))) throw new Error("Expected plain objects or array");
      return {
        added: (n, r) => {
          try {
        ...
        changed: (n, r, i) => {
          try {
            ...
            return [o, a].every(M.array) || [o, a].every(M.plainObject) ? !ae(o, a) : o !== a;
          } catch {
            return !1;
          }
        },
        changedFrom: (n, r, i) => {
          if (!M.defined(n)) return !1;
          try {
            let o = Te(e, n),
              a = Te(t, n),
              s = M.defined(i);
        ...
        decreased: (n, r, i) => {
          if (!M.defined(n)) return !1;
          try {
            return Wn(e, t, { key: n, actual: r, previous: i, type: "decreased" });
          } catch {
            return !1;
          }
        },
        ...
        increased: (n, r, i) => {
          if (!M.defined(n)) return !1;
          try {
            return Wn(e, t, { key: n, actual: r, previous: i, type: "increased" });
          } catch {
            return !1;
          }
        },
    ...
    function $e(e) {
      ...
      for (var t = Je(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling; )
    ...
    function xt(e, t) {
      ...
      var s = Jt(e);
      return s.host ? xt(s.host, t) : xt(e, Jt(t).host);
    }
    function Ve(e) {
    ...
    function sn(e, t) {
      ...
      var u = Me({ top: o.top - a.top - c, left: o.left - a.left - p, width: o.width, height: o.height });
    ...
    function Rr(e, t, n, r, i) {
      ...
      var a = ln(n, r, o, i),
        ...
        l = Object.keys(s)
          .map(function (f) {
            return de({ key: f }, s[f], { area: _i(s[f]) });
          })
          .sort(function (f, b) {
    ...
    function Nr(e, t, n) {
      var r = n === void 0 ? e : e.slice(0, xi(e, "name", n));
      return (
        r.forEach(function (i) {
          ...
          i.enabled &&
            Sr(o) &&
            ((t.offsets.popper = Me(t.offsets.popper)), (t.offsets.reference = Me(t.offsets.reference)), (t = o(t, i)));
        }),
        t
      );
    }
    function Ai() {
      if (!this.state.isDestroyed) {
        ...
        (e.offsets.reference = _r(this.state, this.popper, this.reference, this.options.positionFixed)),
          (e.placement = Rr(
    ...
    function jr(e, t, n, r) {
      ...
      o.addEventListener(t, n, { passive: !0 }), i || jr(yt(o.parentNode), t, n, r), r.push(o);
    }
    function ki(e, t, n, r) {
      (n.updateBound = r), Mr(e).addEventListener("resize", n.updateBound, { passive: !0 });
      var i = yt(e);
      return jr(i, "scroll", n.updateBound, n.scrollParents), (n.scrollElement = i), (n.eventsEnabled = !0), n;
    }
    function Mi() {
      this.state.eventsEnabled || (this.state = ki(this.reference, this.options, this.state, this.scheduleUpdate));
    }
    function ji(e, t) {
      return (
        Mr(e).removeEventListener("resize", t.updateBound),
    ...
    function Li() {
      this.state.eventsEnabled &&
        (cancelAnimationFrame(this.scheduleUpdate), (this.state = ji(this.reference, this.state)));
    }
    function un(e) {
    ...
    function Zt(e, t) {
      Object.keys(t).forEach(function (n) {
        var r = "";
        ["width", "height", "top", "right", "bottom", "left"].indexOf(n) !== -1 && un(t[n]) && (r = "px"),
          (e.style[n] = t[n] + r);
      });
    }
    function Di(e, t) {
    ...
    function Bi(e, t, n, r, i) {
      var o = _r(i, t, e, n.positionFixed),
    ...
    function Wi(e, t) {
      var n = e.offsets,
        ...
        m = t ? (p || u || f ? o : a) : s,
        T = t ? o : s;
      return { left: m(b && !u && t ? r.left - 1 : r.left), top: T(r.top), bottom: T(r.bottom), right: m(r.right) };
    }
    function Hi(e, t) {
      var n = t.x,
        r = t.y,
      ...
      if (
        ...
        (c[b] = "translate3d(" + m + "px, " + T + "px, 0)"), (c[u] = 0), (c[f] = 0), (c.willChange = "transform");
      else {
        var F = u === "bottom" ? -1 : 1,
          I = f === "right" ? -1 : 1;
      ...
      return (
        (e.attributes = de({}, _, e.attributes)),
    ...
    function Lr(e, t, n) {
      ...
      if (!i) {
        var o = "`" + t + "`",
          a = "`" + n + "`";
        console.warn(
          a + " modifier is required by " + o + " modifier in order to work, be sure to include it before " + o + "!"
        );
      }
      return i;
    }
    function Gi(e, t) {
      ...
      var T = s[u] + s[c] / 2 - m / 2,
        ...
        _ = parseFloat(F["border" + p + "Width"]),
        v = T - e.offsets.popper[u] - I - _;
      return (
    ...
    function Yi(e, t) {
      if (kr(e.instance.modifiers, "inner") || (e.flipped && e.placement === e.originalPlacement)) return e;
      var n = ln(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
      ...
      return (
        a.forEach(function (s, l) {
          ...
          var c = e.offsets.popper,
            ...
            I = (r === "left" && b) || (r === "right" && m) || (r === "top" && T) || (r === "bottom" && F),
          ...
          (f || I || R) &&
            ...
            R && (o = zi(o)),
            (e.placement = r + (o ? "-" + o : "")),
            (e.offsets.popper = de({}, e.offsets.popper, Ar(e.instance.popper, e.offsets.reference, e.placement))),
            (e = Nr(e.instance.modifiers, e, "flip")));
        }),
        e
      );
    }
    function qi(e) {
      var t = e.offsets,
        ...
        c = a ? "width" : "height";
      return (
        n[s] < o(r[l]) && (e.offsets.popper[l] = o(r[l]) - n[c]), n[l] > o(r[s]) && (e.offsets.popper[l] = o(r[s])), e
      );
    }
    function $i(e, t, n, r) {
      var i = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/),
    ...
    function Vi(e, t, n, r) {
      ...
      var l = /\s*,\s*|\s+/,
        c = s !== -1 ? [a.slice(0, s).concat([a[s].split(l)[0]]), [a[s].split(l)[1]].concat(a.slice(s + 1))] : [a];
      return (
    ...
    function le(e, t) {
      ...
      if (e && Xn(e) && t && Xn(t)) {
        ...
        if (Jn(e) && Jn(t)) return e.source === t.source && e.flags === t.flags;
        if (e.valueOf !== Object.prototype.valueOf) return e.valueOf() === t.valueOf();
        if (e.toString !== Object.prototype.toString) return e.toString() === t.toString();
        var n = Object.keys(e),
          r = Object.keys(t);
      ...
      return Br(e, t)
        ? [e, t].every(D.array)
          ...
          : [e, t].every(D.plainObject)
            ? !Object.entries(e).some(nr(n)) && Object.entries(t).some(nr(n))
            : t === n
        : !1;
    }
    function Zn(e, t, n) {
    ...
    function ga(e, t) {
      ...
      var n = function (u, f) {
        ...
        a = function (u, f, b) {
          if (!D.defined(u)) return !1;
          try {
            return Zn(e, t, { key: u, actual: f, previous: b, type: "decreased" });
          } catch {
            return !1;
          }
        },
        ...
        c = function (u, f, b) {
          if (!D.defined(u)) return !1;
          try {
            return Zn(e, t, { key: u, actual: f, previous: b, type: "increased" });
          } catch {
            return !1;
          }
        },
      ...
      a &&
        ...
        Array.isArray(n)
          ? n.forEach(function (l) {
              D.plainObject(l) && l.key ? s.apply(console, [l.key, l.value]) : s.apply(console, [l]);
            })
          : s.apply(console, [n]),
        console.groupEnd());
    }
    ...
    function Yr(e) {
      ...
      return (
        ...
        (a || o) && !D.boolean(i) && (c.close = E.createElement(zr, { styles: l.close, handleClick: r })),
        E.createElement(
          "div",
    ...
    function Ma(e) {
      var t = (0, en.default)(ka, e.options || {});
      return {
    ...
    function Wa(e = !0) {
      ...
      if (!t || !n) return 0;
      if (e) {
        let r = [t.scrollHeight, t.offsetHeight, n.clientHeight, n.scrollHeight, n.offsetHeight].sort((o, a) => o - a),
    ...
    function za(e, t, n) {
      ...
      return (
        o instanceof HTMLElement &&
          ((s = o.scrollTop), !a && !dt(e) && (l += s), o.isSameNode(Fe()) || (l += Fe().scrollTop)),
        Math.floor(l - t)
      );
    }
    function Ya(e, t, n) {
    ...
    function $a(e, t) {
      return !M.plainObject(e) || !M.array(t) ? !1 : Object.keys(e).every((n) => t.includes(n));
    }
    function Va(e) {
    ...
    function je({ data: e, debug: t = !1, title: n, warn: r = !1 }) {
      ...
      t &&
        (n && e
          ? (console.groupCollapsed(`%creact-joyride: ${n}`, "color: #ff0044; font-weight: bold; font-size: 12px;"),
            Array.isArray(e)
              ? e.forEach((o) => {
                  M.plainObject(o) && o.key ? i.apply(console, [o.key, o.value]) : i.apply(console, [o]);
                })
              : i.apply(console, [e]),
            console.groupEnd())
    ...
    function Qr(e, ...t) {
      if (!M.plainObject(e)) throw new TypeError("Expected an object");
      let n = {};
    ...
    function Ja(e) {
      let { isFirstStep: t, lifecycle: n, previousLifecycle: r, scrollToFirstStep: i, step: o, target: a } = e;
      return (
        !o.disableScrolling &&
        (!t || i || n === W.TOOLTIP) &&
        o.placement !== "center" &&
    ...
    function ns(e, t) {
      ...
      window.innerWidth > 480 && (b = 380),
        "width" in u &&
          (b = typeof u.width == "number" && window.innerWidth < u.width ? window.innerWidth - 30 : u.width);
      let m = { bottom: 0, left: 0, overflow: "hidden", position: "absolute", right: 0, top: 0, zIndex: u.zIndex },
        T = {
          beacon: {
            ...ft,
          ...
          spotlightLegacy: { ...ur, boxShadow: `0 0 0 9999px ${u.overlayColor}, ${u.spotlightShadow}` },
          floaterStyles: {
            arrow: {
              color:
                (a = (o = (i = c?.styles) == null ? void 0 : i.arrow) == null ? void 0 : o.color) != null
                  ? a
                  : u.arrowColor,
            },
    ...
    function qe(e, t) {
      var n, r, i, o, a, s;
      let l = t ?? {},
        c = Ct.default.all([Za, rs(e), l], { isMergeableObject: M.plainObject }),
        p = ns(e, c),
        u = Ot(ke(c.target), c.disableScrollParentFix),
        f = Ct.default.all([Xa, (n = e.floaterProps) != null ? n : {}, (r = c.floaterProps) != null ? r : {}]);
      return (
        (f.offset = c.offset),
        (f.styles = (0, Ct.default)((i = f.styles) != null ? i : {}, p.floaterStyles)),
        (f.offset += (a = (o = e.spotlightPadding) != null ? o : c.spotlightPadding) != null ? a : 0),
        ...
        {
          ...c,
          locale: Ct.default.all([Jr, (s = e.locale) != null ? s : {}, c.locale || {}]),
          floaterProps: f,
          styles: Qr(p, "floaterStyles"),
        }
      );
    }
    function Xr(e, t = !1) {
      return M.plainObject(e)
        ? e.target
          ? !0
          : (je({ title: "validateStep", data: "target is missing from the step", warn: !0, debug: t }), !1)
        : (je({ title: "validateStep", data: "step must be an object", warn: !0, debug: t }), !1);
    }
    function pr(e, t = !1) {
      return M.array(e)
        ? e.every((n) => Xr(n, t))
        : (je({ title: "validateSteps", data: "steps must be an array", warn: !0, debug: t }), !1);
    }
    function is(e) {
      return new os(e);
    }
    ...
    function hs(e) {
      let {
        ...
        Q = { primary: R };
      return (
        r && ((Q.primary = o ? K : B), F && (Q.primary = V("span", null, Q.primary, " (", i + 1, "/", s, ")"))),
        Q.primary &&
          (Q.primary = V(
            "button",
            { "data-test-id": "button-primary", style: _.buttonNext, type: "button", ...a },
            Q.primary
          )),
        I &&
          !o &&
          (Q.skip = V(
            "button",
            { "aria-live": "off", "data-test-id": "button-skip", style: _.buttonSkip, type: "button", ...l },
            te
          )),
        !f &&
          i > 0 &&
          (Q.back = V("button", { "data-test-id": "button-back", style: _.buttonBack, type: "button", ...t }, P)),
        (Q.close = !b && V(ds, { "data-test-id": "button-close", styles: _.buttonClose, ...n })),
        V(
          "div",
          {
            key: "JoyrideTooltip",
            "aria-label": Ne(v) || Ne(u),
          ...
          V(
            ...
            v && V("h1", { "aria-label": Ne(v), style: _.tooltipTitle }, v),
            V("div", { style: _.tooltipContent }, u)
          ),
          !m &&
            V("div", { style: _.tooltipFooter }, V("div", { style: _.tooltipFooterSpacer }, Q.skip), Q.back, Q.primary),
          Q.close
        )
      );
    }
    function _s({ step: e, steps: t, onClose: n, onComplete: r }) {
      let [i, o] = ue(null),
        a = xn();
      return (
        ce(() => {
    ...
    function Gs({ api: e }) {
      let [t, n] = ue(!0),
        ...
        T = ze(
          (B) => {
            try {
              let { id: te, refId: Q } = e.getCurrentStoryData() || {};
              (te !== B || Q !== void 0) && e.selectStory(B);
            } catch {}
          },
          [e]
        ),
        ...
        I = ze(() => {
          e.emit(Dn, { step: "6:FinishedOnboarding", type: "telemetry" }), T("configure-your-project--docs"), F();
        }, [e, T, F]);
      if (
        (ce(() => {
        ...
        ce(
          () =>
            e.on(wn, ({ payload: B, success: te }) => {
              !te ||
                !B?.newStoryName ||
                (m(B), i(!0), a("5:StoryCreated"), setTimeout(() => e.clearNotification("save-story-success")));
            }),
          [e]
        ),
        ...
        return null;
      let _ = b?.sourceFileContent,
        v = _?.lastIndexOf(`export const ${b?.newStoryExportName}`),
        P = _?.slice(v).trim(),
        R = _?.slice(0, v).split(`
`).length,
        K = [
          {
            ...
            content: E.createElement(
              ...
              E.createElement(Ln, { targetSelector: "#control-primary", pulsating: !0 })
            ),
            offset: 20,
            placement: "right",
            disableBeacon: !0,
          ...
          },
          {
            ...
            content: E.createElement(
              ...
              E.createElement(Ln, { targetSelector: "button[aria-label='Create new story with these settings']" })
            ),
            offset: 6,
            placement: "top",
            disableBeacon: !0,
              ...
              P &&
                E.createElement(
                  ...
                  E.createElement(
                    Us,
                    null,
                    E.createElement(Pn, { language: "jsx", showLineNumbers: !0, startingLineNumber: R }, P)
                  )
                )
            ),
            offset: 12,
      ...
      return E.createElement(
        ...
        o === "1:Intro"
          ...
          : E.createElement(_s, { step: o, steps: K, onClose: F, onComplete: I })
      );
    }
    var hr,
      Wo,
      ...
      ro = ye(() => {
        ...
        (Wo = Object.create),
          ...
          (zo = (e, t, n, r) => {
            if ((t && typeof t == "object") || typeof t == "function")
              for (let i of mr(t))
                !Go.call(e, i) && i !== n && yr(e, i, { get: () => t[i], enumerable: !(r = Uo(t, i)) || r.enumerable });
            return e;
          }),
          (Be = (e, t, n) => (
            (n = e != null ? Wo(Ho(e)) : {}),
              ...
              function F(v, P, R) {
                ...
                return (
                  ...
                  b(P).forEach(function (B) {
                    T(v, B) ||
                      (m(v, B) && R.isMergeableObject(P[B]) ? (K[B] = u(B, R)(v[B], P[B], R)) : (K[B] = c(P[B], R)));
                  }),
                  K
                );
              }
          ...
          (Qo = he({
            "../../node_modules/prop-types/factoryWithTypeCheckers.js"(e, t) {
              ...
              t.exports = function (c, p) {
                ...
                function R(S) {
                  function k(H, G, d, h, g) {
                    if (typeof S != "function")
                      return new I(
                        "Property `" + g + "` of component `" + d + "` has invalid PropType notation inside arrayOf."
                      );
                    var y = H[G];
                    if (!Array.isArray(y)) {
                      var N = pe(y);
                      return new I(
                        "Invalid " +
                          ...
                          g +
                          "` of type " +
                          ("`" + N + "` supplied to `" + d + "`, expected an array.")
                      );
                    }
                    for (var j = 0; j < y.length; j++) {
                      var w = S(y, j, d, h, g + "[" + j + "]", i);
                    ...
                    if (!n.isValidElementType(g)) {
                      ...
                      return new I(
                        "Invalid " +
                          ...
                          h +
                          "` of type " +
                          ("`" + y + "` supplied to `" + G + "`, expected a single ReactElement type.")
                      );
                    }
                    return null;
                  }
                ...
                function Q(S) {
                  ...
                  function k(H, G, d, h, g) {
                    for (var y = H[G], N = 0; N < S.length; N++) if (F(y, S[N])) return null;
                    var j = JSON.stringify(S, function (w, O) {
                      var U = fe(O);
                ...
                function se(S) {
                  function k(H, G, d, h, g) {
                    if (typeof S != "function")
                      return new I(
                        "Property `" + g + "` of component `" + d + "` has invalid PropType notation inside objectOf."
                      );
                    var y = H[G],
                      N = pe(y);
                    if (N !== "object")
                      return new I(
                        "Invalid " +
                          ...
                          g +
                          "` of type " +
                          ("`" + N + "` supplied to `" + d + "`, expected an object.")
                      );
                    for (var j in y)
                      if (o(y, j)) {
                        var w = S(y, j, d, h, g + "." + j, i);
                ...
                function Ze(S) {
                  if (!Array.isArray(S))
                    return s("Invalid argument supplied to oneOfType, expected an instance of array."), l;
                  ...
                  function G(d, h, g, y, N) {
                    for (var j = [], w = 0; w < S.length; w++) {
                      var O = S[w],
                        U = O(d, h, g, y, N, i);
                      if (U == null) return null;
                      U.data && o(U.data, "expectedType") && j.push(U.data.expectedType);
                    }
                    var z = j.length > 0 ? ", expected one of type [" + j.join(", ") + "]" : "";
                    return new I("Invalid " + y + " `" + N + "` supplied to " + ("`" + g + "`" + z + "."));
                  }
                  return _(G);
                }
                function Ue() {
                  function S(k, H, G, d, h) {
                    return Ce(k[H])
                      ? null
                      : new I("Invalid " + d + " `" + h + "` supplied to " + ("`" + G + "`, expected a ReactNode."));
                  }
                  return _(S);
                }
                function Re(S, k, H, G, d) {
                  return new I(
                    (S || "React class") +
                      ": " +
                      k +
                ...
                function et(S) {
                  function k(H, G, d, h, g) {
                    ...
                    for (var j in S) {
                      var w = S[j];
                      if (typeof w != "function") return Re(d, h, g, j, fe(w));
                      var O = w(y, j, d, h, g + "." + j, i);
                      if (O) return O;
                    }
                    return null;
                  }
...
Valid keys: ` +
                ...
                function pe(S) {
                  var k = typeof S;
                  return Array.isArray(S) ? "array" : S instanceof RegExp ? "object" : tt(k, S) ? "symbol" : k;
                }
                function fe(S) {
          ...
          (Jo = he({
            "../../node_modules/prop-types/index.js"(e, t) {
              (n = gr()), (r = !0), (t.exports = Qo()(n.isElement, r));
              var n, r;
            },
          })),
          (Xo = he({
          ...
          (Zo = re.div(({ width: e, height: t, left: n, top: r }) => ({
            width: `${e}px`,
            height: `${t}px`,
            left: `${n}px`,
            top: `${r}px`,
        ...
        (ri = Er("function")),
          (oi = (e) => e === null),
          (Fn = (e) => Object.prototype.toString.call(e).slice(8, -1) === "RegExp"),
          (Bn = (e) => !ii(e) && !oi(e) && (ri(e) || typeof e == "object")),
          (ii = Er("undefined"));
        (ui = [
          "Array",
          "ArrayBuffer",
          ...
          (pi = ["bigint", "boolean", "null", "number", "string", "symbol", "undefined"]);
        hi = ["innerHTML", "ownerDocument", "style", "attributes", "nodeValue"];
        x.array = Array.isArray;
        x.arrayOf = (e, t) => (!x.array(e) && !x.function(t) ? !1 : e.every((n) => t(n)));
        x.asyncGeneratorFunction = (e) => kt(e) === "AsyncGeneratorFunction";
        x.asyncFunction = Ee("AsyncFunction");
        x.bigint = Qe("bigint");
        x.boolean = (e) => e === !0 || e === !1;
        x.date = Ee("Date");
        x.defined = (e) => !x.undefined(e);
        x.domElement = (e) =>
          x.object(e) && !x.plainObject(e) && e.nodeType === 1 && x.string(e.nodeName) && hi.every((t) => t in e);
        x.empty = (e) =>
          (x.string(e) && e.length === 0) ||
          (x.array(e) && e.length === 0) ||
          (x.object(e) && !x.map(e) && !x.set(e) && Object.keys(e).length === 0) ||
          (x.set(e) && e.size === 0) ||
          (x.map(e) && e.size === 0);
        x.error = Ee("Error");
        x.function = Qe("function");
        x.generator = (e) => x.iterable(e) && x.function(e.next) && x.function(e.throw);
        x.generatorFunction = Ee("GeneratorFunction");
        x.instanceOf = (e, t) => (!e || !t ? !1 : Object.getPrototypeOf(e) === t.prototype);
        x.iterable = (e) => !x.nullOrUndefined(e) && x.function(e[Symbol.iterator]);
        x.map = Ee("Map");
        x.nan = (e) => Number.isNaN(e);
        x.null = (e) => e === null;
        x.nullOrUndefined = (e) => x.null(e) || x.undefined(e);
        x.number = (e) => Qe("number")(e) && !x.nan(e);
        x.numericString = (e) => x.string(e) && e.length > 0 && !Number.isNaN(Number(e));
        x.object = (e) => !x.nullOrUndefined(e) && (x.function(e) || typeof e == "object");
        x.oneOf = (e, t) => (x.array(e) ? e.indexOf(t) > -1 : !1);
        x.plainFunction = Ee("Function");
        x.plainObject = (e) => {
          if (kt(e) !== "Object") return !1;
          let t = Object.getPrototypeOf(e);
          return t === null || t === Object.getPrototypeOf({});
        };
        x.primitive = (e) => x.null(e) || di(typeof e);
        x.promise = Ee("Promise");
        x.propertyOf = (e, t, n) => {
          if (!x.object(e) || !t) return !1;
          let r = e[t];
          return x.function(n) ? n(r) : x.defined(r);
        };
        x.regexp = Ee("RegExp");
        x.set = Ee("Set");
        x.string = Qe("string");
        x.symbol = Qe("symbol");
        x.undefined = Qe("undefined");
        x.weakMap = Ee("WeakMap");
        x.weakSet = Ee("WeakSet");
        M = x;
        (bi = Be(Yo(), 1)),
          (wr = Be(qo(), 1)),
          (Ct = Be(rn(), 1)),
        ...
        (Yn = ht && !!(window.MSInputMethodContext && document.documentMode)),
        ...
        (ea = {
          shift: { order: 100, enabled: !0, fn: Ji },
          ...
          arrow: { order: 500, enabled: !0, fn: Gi, element: "[x-arrow]" },
          flip: {
            order: 600,
            enabled: !0,
            fn: Yi,
          ...
          computeStyle: { order: 850, enabled: !0, fn: Hi, gpuAcceleration: !0, x: "bottom", y: "right" },
          applyStyle: { order: 900, enabled: !0, fn: Fi, onLoad: Bi, gpuAcceleration: void 0 },
        }),
          (ta = {
            placement: "bottom",
            positionFixed: !1,
        ...
        (Qn = Mt),
          (en = Be(rn())),
          (na = ["innerHTML", "ownerDocument", "style", "attributes", "nodeValue"]),
          (ra = [
            "Array",
            "ArrayBuffer",
            "AsyncFunction",
          ...
          (oa = ["bigint", "boolean", "null", "number", "string", "symbol", "undefined"]);
        ...
        A.asyncGeneratorFunction = function (e) {
          return jt(e) === "AsyncGeneratorFunction";
        };
        ...
        (sa = Fr("function")),
          ...
          (Xn = function (e) {
            return !ca(e) && !la(e) && (sa(e) || typeof e == "object");
          }),
          (ca = Fr("undefined")),
          (tn = function (e) {
        ...
        (wa = { flip: { padding: 20 }, preventOverflow: { padding: 10 } }),
          (Sa =
            "The typeValidator argument must be a function with the signature function(props, propName, componentName)."),
          (Ta = "The error message is optional, but must be a string if provided.");
        (q = { INIT: "init", IDLE: "idle", OPENING: "opening", OPEN: "open", CLOSING: "closing", ERROR: "error" }),
                  ...
                  return (
                    ...
                    E.createElement(
                      ...
                      E.createElement(
                        ...
                        E.createElement(
                          "svg",
                          { width: F, height: I, version: "1.1", xmlns: "http://www.w3.org/2000/svg" },
        ...
        Na = ["color", "height", "width"];
        zr.propTypes = { handleClick: C.default.func.isRequired, styles: C.default.object.isRequired };
        Yr.propTypes = {
            ...
            bt(n, [
              {
                ...
                value: function () {
                  ...
                  return f
                    ? E.createElement(
                        "span",
                        { ref: c, style: ee(ee({}, u), p), onClick: o, onMouseEnter: a, onMouseLeave: s },
                        f
                      )
                    : null;
                },
              ...
              return (
                ...
                oe(Pe(i), "handleMouseEnter", function () {
                  ...
                  if (!(D.boolean(s) || Qt())) {
                    ...
                    i.event === "hover" &&
                      l === q.IDLE &&
                      (Rt({ title: "mouseEnter", data: [{ key: "originalEvent", value: a }], debug: i.debug }),
                ...
                oe(Pe(i), "handleMouseLeave", function () {
                  ...
                  if (!(D.boolean(l) || Qt())) {
                    var c = i.state,
                      ...
                      u = c.positionWrapper;
                    i.event === "hover" &&
                      (Rt({ title: "mouseLeave", data: [{ key: "originalEvent", value: a }], debug: i.debug }),
                      s
                    ...
                    if (Se()) {
                      ...
                      (r.wrapperOptions.position !== c.position || r.target !== l) &&
                        ...
                        this.floaterRef &&
                          ...
                          Aa(this.floaterRef, "transitionend", this.handleTransitionEnd),
                    ...
                    if (u === "center") this.setState({ status: q.IDLE });
                      ...
                      new Qn(i, this.floaterRef, {
                        ...
                        onCreate: function (P) {
                          ...
                          l(P, "floater"),
                            r._isMounted && r.setState({ currentPlacement: P.placement, status: q.IDLE }),
                            u !== P.placement &&
                              setTimeout(function () {
                                P.instance.update();
                              }, 1);
                        ...
                        onUpdate: function (P) {
                          ...
                          r._isMounted && P.placement !== R && r.setState({ currentPlacement: P.placement });
                        },
                      });
                    }
                    if (o) {
                      var v = D.undefined(f.offset) ? 0 : f.offset;
                      new Qn(this.target, this.wrapperRef, {
        ...
        oe(fn, "propTypes", {
          ...
          children: C.default.node,
          component: ar(C.default.oneOfType([C.default.func, C.default.element]), function (e) {
            return !e.content;
          }),
        ...
        (Da = Be(Xo(), 1)),
          ...
          (L = (e, t, n) => (Ba(e, typeof t != "symbol" ? t + "" : t, n), n)),
          ($ = {
            INIT: "init",
            START: "start",
            STOP: "stop",
        ...
        (Xa = {
          ...
          (Jr = { back: "Back", close: "Close", last: "Last", next: "Next", open: "Open the dialog", skip: "Skip" }),
          (Za = {
            event: "click",
            placement: "bottom",
            offset: 10,
        ...
        (Zr = { action: "init", controlled: !1, index: 0, lifecycle: W.INIT, origin: null, size: 0, status: Y.IDLE }),
          (fr = Ka(Qr(Zr, "controlled", "size"))),
          (os = class {
            constructor(e) {
              L(this, "beaconPopper"),
                ...
                L(this, "close", (i = null) => {
                  ...
                  a === Y.RUNNING &&
                    this.setState({ ...this.getNextState({ action: $.CLOSE, index: o + 1, origin: i }) });
                }),
                L(this, "go", (i) => {
                  let { controlled: o, status: a } = this.getState();
                  if (o || a !== Y.RUNNING) return;
                  let s = this.getSteps()[i];
                  this.setState({ ...this.getNextState({ action: $.GO, index: i }), status: s ? a : Y.FINISHED });
                }),
                L(this, "info", () => this.getState()),
                L(this, "next", () => {
                  let { index: i, status: o } = this.getState();
                  o === Y.RUNNING && this.setState(this.getNextState({ action: $.NEXT, index: i + 1 }));
                }),
                L(this, "open", () => {
                  let { status: i } = this.getState();
                  i === Y.RUNNING &&
                    this.setState({ ...this.getNextState({ action: $.UPDATE, lifecycle: W.TOOLTIP }) });
                }),
                L(this, "prev", () => {
                  let { index: i, status: o } = this.getState();
                  o === Y.RUNNING && this.setState({ ...this.getNextState({ action: $.PREV, index: i - 1 }) });
                }),
                L(this, "reset", (i = !1) => {
                ...
                L(this, "skip", () => {
                  let { status: i } = this.getState();
                  i === Y.RUNNING && this.setState({ action: $.SKIP, lifecycle: W.INIT, status: Y.SKIPPED });
                }),
                L(this, "start", (i) => {
                  let { index: o, size: a } = this.getState();
                  this.setState({
                    ...this.getNextState({ action: $.START, index: M.number(i) ? i : o }, !0),
                ...
                L(this, "update", (i) => {
                  var o, a;
                  if (!$a(i, fr)) throw new Error(`State is not valid. Valid keys: ${fr.join(", ")}`);
                  this.setState({
                    ...this.getNextState(
                      {
                        ...this.getState(),
              ...
              this.setState(
                {
                  action: $.INIT,
                  controlled: M.number(n),
                  continuous: t,
                  index: M.number(n) ? n : 0,
                  lifecycle: W.INIT,
                  origin: null,
            ...
            setState(e, t = !1) {
              let n = this.getState(),
                { action: r, index: i, lifecycle: o, origin: a = null, size: s, status: l } = { ...n, ...e };
          ...
          (ls = class extends xe {
              ...
              i("lifecycle", W.TOOLTIP) &&
                ...
                (i("spotlightClicks") || i("disableOverlay") || i("lifecycle")) &&
                  (r && n === W.TOOLTIP
                    ...
                    : n !== W.TOOLTIP && window.removeEventListener("mousemove", this.handleMouseMove));
            }
            ...
            get overlayStyles() {
              let { mouseOverSpotlight: e } = this.state,
                ...
                i = r.overlay;
              return (
                cr() && (i = n === "center" ? r.overlayLegacyCenter : r.overlayLegacy),
                { cursor: t ? "default" : "pointer", height: Wa(), pointerEvents: e ? "none" : "auto", ...i }
              );
            }
            get spotlightStyles() {
              var e, t, n;
      ...
      `)
            ...
            componentDidMount() {
              ...
              M.domElement(this.beacon) || console.warn("beacon is not a valid DOM element"),
                setTimeout(() => {
                  M.domElement(this.beacon) && e && this.beacon.focus();
                }, 0);
            }
            componentWillUnmount() {
            ...
            render() {
              let {
                ...
                c = M.string(i.open) ? i.open : (0, Da.default)(i.open),
                p = { "aria-label": c, onClick: o, onMouseEnter: o, ref: this.setBeaconRef, title: c },
                u;
              return (
                e
        ...
        (ys = hs),
          (ms = class extends xe {
            ...
            render() {
              ...
              if (s) {
                ...
                c = V(ys, { ...this.getElementsProps(), continuous: e, index: t, isLastStep: n, size: i, step: o });
              return c;
            }
          }),
          (gs = class extends xe {
            constructor() {
              super(...arguments),
                ...
                L(this, "handleClickHoverBeacon", (e) => {
                  ...
                  (e.type === "mouseenter" && t.event !== "hover") || n.update({ lifecycle: W.TOOLTIP });
                }),
            ...
            componentDidMount() {
              ...
              je({ title: `step:${t}`, data: [{ key: "props", value: this.props }], debug: e });
            }
            componentDidUpdate(e) {
              var t;
              let {
                ...
                { changed: b, changedFrom: m } = _t(e, this.props),
                T = s.info(),
                F = i && n !== $.CLOSE && (l > 0 || n === $.PREV),
                I = b("action") || b("index") || b("lifecycle") || b("status"),
                _ = m("lifecycle", [W.TOOLTIP, W.INIT], W.INIT),
                v = b("action", [$.NEXT, $.PREV, $.SKIP, $.CLOSE]),
                P = o && l === e.index;
              if (
                (v && (_ || P) && r({ ...T, index: e.index, lifecycle: W.COMPLETE, step: e.step, type: ve.STEP_AFTER }),
                u.placement === "center" &&
                  p === Y.RUNNING &&
                  b("index") &&
                  n !== $.START &&
              ...
              m("lifecycle", W.INIT, W.READY) && f.update({ lifecycle: lr(u) || F ? W.TOOLTIP : W.BEACON }),
                b("index") && je({ title: `step:${c}`, data: [{ key: "props", value: this.props }], debug: a }),
                b("lifecycle", W.BEACON) && r({ ...T, step: u, type: ve.BEACON }),
                b("lifecycle", W.TOOLTIP) &&
                  (r({ ...T, step: u, type: ve.TOOLTIP }),
                  this.tooltip &&
                    ((this.scope = new us(this.tooltip, { selector: "[data-action=primary]" })),
                    this.scope.setFocus())),
            ...
            render() {
              let { continuous: e, debug: t, index: n, nonce: r, shouldScroll: i, size: o, step: a } = this.props,
                s = ke(a.target);
              return !Xr(a) || !M.domElement(s)
                ? null
                : V(
                    "div",
          ...
          (eo = class extends xe {
            constructor(e) {
              super(e),
                ...
                L(this, "handleKeyboard", (a) => {
                  let { index: s, lifecycle: l } = this.state,
                    { steps: c } = this.props,
                    p = c[s];
                  l === W.TOOLTIP && a.code === "Escape" && p && !p.disableCloseOnEsc && this.store.close("keyboard");
                }),
              ...
              (this.store = is({ ...e, controlled: r && M.number(i) })), (this.helpers = this.store.getHelpers());
            ...
            componentDidUpdate(e, t) {
              ...
              let { action: n, controlled: r, index: i, lifecycle: o, status: a } = this.state,
                ...
                { changed: _ } = _t(e, this.props),
                { changed: v, changedFrom: P } = _t(t, this.state),
                R = qe(this.props, p[i]),
                K = !ae(f, p),
                B = M.number(c) && _("stepIndex"),
                te = ke(R.target);
              if ((K && (pr(p, s) ? m(p) : console.warn("Steps are not valid", p)), _("run") && (l ? T(c) : F()), B)) {
                let se = M.number(u) && u < c ? $.NEXT : $.PREV;
                n === $.STOP && (se = $.START),
                  [Y.FINISHED, Y.SKIPPED].includes(a) ||
              ...
              let Q = { ...this.state, index: i, step: R };
              if (v("action", [$.NEXT, $.PREV, $.SKIP, $.CLOSE]) && v("status", Y.PAUSED)) {
                let se = qe(this.props, p[t.index]);
                this.callback({ ...Q, index: t.index, lifecycle: W.COMPLETE, step: se, type: ve.STEP_AFTER });
              }
              if (v("status", [Y.FINISHED, Y.SKIPPED])) {
                let se = qe(this.props, p[t.index]);
                r || this.callback({ ...Q, index: t.index, lifecycle: W.COMPLETE, step: se, type: ve.STEP_AFTER }),
                  this.callback({ ...Q, type: ve.TOUR_END, step: se, index: t.index }),
                  b();
              } else
                P("status", [Y.IDLE, Y.READY], Y.RUNNING)
                  ? this.callback({ ...Q, type: ve.TOUR_START })
                  : (v("status") || v("action", $.RESET)) && this.callback({ ...Q, type: ve.TOUR_STATUS });
              this.scrollToStep(t),
                R.placement === "center" &&
                  a === Y.RUNNING &&
                  o === W.INIT &&
            ...
            scrollToStep(e) {
              ...
              if (r === Y.RUNNING && f) {
                ...
                if (n === W.BEACON && F) {
                  let { offsets: _, placement: v } = F;
                  !["bottom"].includes(v) && !b && (T = Math.floor(_.popper.top - s));
                } else if (n === W.TOOLTIP && I) {
                  let { flipped: _, offsets: v, placement: P } = I;
                  ["top", "right", "left"].includes(P) && !_ && !b
                ...
                (T = T >= 0 ? T : 0),
                  r === Y.RUNNING &&
                    qa(T, { element: m, duration: a }).then(() => {
                      setTimeout(() => {
                        var _;
                        (_ = this.store.getPopper("tooltip")) == null || _.instance.update();
                      }, 10);
                    });
              }
            }
            render() {
              ...
              let { index: e, lifecycle: t, status: n } = this.state,
                { continuous: r = !1, debug: i = !1, nonce: o, scrollToFirstStep: a = !1, steps: s } = this.props,
                l = n === Y.RUNNING,
                c = {};
              if (l && s[e]) {
                ...
                (c.step = V(gs, {
                  ...
                  (c.overlay = V(
                    ...
                    V(ls, { ...p, continuous: r, debug: i, lifecycle: t, onClickOverlay: this.handleClickOverlay })
                  ));
              }
...
`),
          (Es = Ut(function ({ children: e, onClick: t, variant: n = "primary", ...r }, i) {
            return E.createElement(vs, { ref: i, onClick: t, variant: n, ...r }, e);
          })),
          (Os = re.div`
  padding: 15px;
  border-radius: 5px;
...
`),
  ...
  font-size: 13px;
`),
          (Rs = ({ index: e, size: t, step: n, closeProps: r, primaryProps: i, tooltipProps: o }) => (
            ce(() => {
    ...
    `),
            ...
            E.createElement(
              ...
              E.createElement(
                ...
                E.createElement(
                  Ss,
                  null,
                  n.title && E.createElement(Ts, null, n.title),
                  E.createElement(Cn, { ...r, onClick: r.onClick, variant: "solid" }, E.createElement(Mn, null))
                ),
        ...
        (xs = at({ from: { opacity: 0 }, to: { opacity: 1 } })),
          (to = at({
            from: { transform: "translate(0, 20px)", opacity: 0 },
            to: { transform: "translate(0, 0)", opacity: 1 },
          })),
          (As = at({ from: { opacity: 0, transform: "scale(0.8)" }, to: { opacity: 1, transform: "scale(1)" } })),
          (Ns = at({ "0%": { transform: "rotate(0deg)" }, "100%": { transform: "rotate(360deg)" } })),
          (ks = re.div(({ visible: e }) => ({
            position: "fixed",
            top: 0,
            left: 0,
    ...
    radial-gradient(circle at 75% 75%, #fc521f99 0%, #fc521f77 18%, transparent 30%)`,
      ...
      radial-gradient(circle at 75% 75%, #fc521f99 0%, #fc521f77 8%, transparent 20%)`,
              ...
              animation: `${Ns} 12s linear infinite`,
            },
          })),
          (js = re.div(({ visible: e }) => ({
            position: "absolute",
              ...
              E.createElement(
                ...
                E.createElement(
                  ...
                  E.createElement(
                    ...
                    E.createElement(dr, { xmlns: "http://www.w3.org/2000/svg" }, E.createElement("circle", null)),
                    E.createElement(
                      dr,
    ...
    X();
    Z();
    var _c = __STORYBOOK_API__,
      {
        ActiveTabs: xc,
        Consumer: Ac,
        ManagerContext: Nc,
        Provider: kc,
        RequestResponseError: Mc,
        addons: In,
        combineParameters: jc,
        controlOrMetaKey: Lc,
        controlOrMetaSymbol: Dc,
        eventMatchesShortcut: Fc,
        eventToShortcut: Bc,
        experimental_requestResponse: Wc,
        isMacLike: Uc,
        isShortcutTaken: Hc,
        keyToSymbol: Gc,
        merge: zc,
        mockChannel: Yc,
        optionOrAltSymbol: qc,
        shortcutMatchesShortcut: $c,
    ...
    In.register("@storybook/addon-onboarding", async (e) => {
      ...
      e.once(Sn, () => {
        ...
        (r.id = "storybook-addon-onboarding"),
          ...
          De.render(
            E.createElement(Wt, { fallback: E.createElement("div", null) }, E.createElement(zs, { api: e })),
            r
          );
      });
    });
