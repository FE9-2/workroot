  ...
  (() => {
    ...
    var ue = (e, o, a, r) => {
      if ((o && typeof o == "object") || typeof o == "function")
        for (let c of ie(o))
          !le.call(e, c) && c !== a && Y(e, c, { get: () => o[c], enumerable: !(r = ce(o, c)) || r.enumerable });
      return e;
    };
    var Ie = (e, o, a) => (
      (a = e != null ? re(ae(e)) : {}),
      ue(o || !e || !e.__esModule ? Y(a, "default", { value: e, enumerable: !0 }) : a, e)
    );
    var p = M(() => {});
    var h = M(() => {});
    var f = M(() => {});
    var X = se((Q, V) => {
      ...
      (function (e) {
        if (typeof Q == "object" && typeof V < "u") V.exports = e();
          ...
          var o;
          typeof window < "u" || typeof window < "u" ? (o = window) : typeof self < "u" ? (o = self) : (o = this),
            (o.memoizerific = e());
        }
      })(function () {
        var e, o, a;
              ...
              function (r, c, d) {
                ...
                (l.prototype.get = function (t) {
                  ...
                  (l.prototype.delete = function (t) {
                    var n;
                    if (
                      (this.lastItem && this.isEqual(this.lastItem.key, t) && (this.lastItem = void 0),
                      (n = this.indexOf(t)),
                      n >= 0)
                    )
              ...
              function (r, c, d) {
                ...
                c.exports = function (i) {
                  ...
                  return function (C) {
                    ...
                    return (m.limit = i), (m.wasMemoized = !1), (m.cache = I), (m.lru = s), m;
                  };
                };
                function t(i, I) {
                  var s = i.length,
                ...
                function n(i) {
                  ...
                  for (
                    ...
                    m >= 0 && ((s = i[m]), (C = s.cacheItem.get(s.arg)), !C || !C.size);
                    m--
                  )
    ...
    var Ba = __STORYBOOK_CLIENT_LOGGER__,
      { deprecate: Ra, logger: K, once: xa, pretty: La } = __STORYBOOK_CLIENT_LOGGER__;
    var W = Ie(X());
    p();
    h();
    f();
      ...
      var c = r.reduce(function (t, n) {
        ...
        return u
          ? t.concat(
              u.map(function (i) {
                var I, s;
                return (s = (I = i.match(/[\t ]/g)) === null || I === void 0 ? void 0 : I.length) !== null &&
                  s !== void 0
                  ? s
                  : 0;
              })
...
`)),
    ...
    var ne = "storybook/background",
      ...
      ge = (0, W.default)(10)((e, o, a) => {
        let r = e.map(({ name: c, value: d }) => te(null, c, d, !0, a, d === o));
        return o !== "transparent" ? [te("reset", "Clear background", "transparent", null, a, !1), ...r] : r;
      }),
      ...
      N.add(ne, {
        ...
        render: () =>
          FEATURES?.backgroundsStoryGlobals
            ...
            : g.createElement(D, null, g.createElement(Ce, null), g.createElement(ye, null)),
      });
    });
  })();
} catch (e) {
