...
import "./index-j_8AUxV0.js";
import "./index-DrFu-skq.js";
const n = "" + new URL("accessibility-W_h2acOZ.png", import.meta.url).href,
  c = "" + new URL("addon-library-BWUCAmyN.png", import.meta.url).href,
  l =
  ...
  d = "" + new URL("context-C0qIqeS4.png", import.meta.url).href,
  g =
  ...
  h = "" + new URL("docs---vsFbMi.png", import.meta.url).href,
  m = "" + new URL("figma-plugin-CH2hELiO.png", import.meta.url).href,
  p =
  ...
  b = "" + new URL("styling-Bk6zjRzU.png", import.meta.url).href,
          ...
          e.jsxs("div", {
            ...
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("img", { src: b, alt: "A wall of logos representing different styling technologies" }),
                  e.jsx("h4", { className: "sb-section-item-heading", children: "Add styling and CSS" }),
                  e.jsx("p", {
              ...
              e.jsxs("div", {
                className: "sb-section-item",
                children: [
                  e.jsx("img", { src: d, alt: "An abstraction representing the composition of data for a component" }),
                  e.jsx("h4", { className: "sb-section-item-heading", children: "Provide context and mocking" }),
                  e.jsx("p", {
                    className: "sb-section-item-paragraph",
                    children:
              ...
              e.jsxs("div", {
                className: "sb-section-item",
                children: [
                  e.jsx("img", { src: l, alt: "A representation of typography and image assets" }),
                  e.jsxs("div", {
                    children: [
                      e.jsx("h4", { className: "sb-section-item-heading", children: "Load assets and resources" }),
                      e.jsxs("p", {
                        className: "sb-section-item-paragraph",
                        children: [
...
interactive reference documentation from your components and stories.`,
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsx("h4", { className: "sb-section-item-heading", children: "Publish to Chromatic" }),
                    e.jsx("p", {
                      className: "sb-section-item-paragraph",
                ...
                e.jsxs("div", {
                  className: "sb-grid-item",
                  children: [
                    e.jsx("img", { src: m, alt: "Windows showing the Storybook plugin in Figma" }),
...
complex.`,
                ...
                e.jsxs("div", {
                  className: "sb-grid-item",
                  children: [
                    e.jsx("img", { src: n, alt: "Screenshot of accessibility tests passing and failing" }),
                    e.jsx("h4", { className: "sb-section-item-heading", children: "Accessibility" }),
                    e.jsx("p", {
                      className: "sb-section-item-paragraph",
      ...
      e.jsxs("div", {
        ...
        children: [
          ...
          e.jsx("div", {
            ...
            children: e.jsx("img", { src: c, alt: "Integrate your tools with Storybook to connect workflows." }),
          }),
        ],
      }),
      `
      ...
      e.jsxs("div", {
        ...
        children: [
          e.jsxs("div", {
            className: "sb-section-item",
            children: [
              e.jsx("img", { src: p, alt: "Github logo", className: "sb-explore-image" }),
              e.jsx(i.p, { children: "Join our contributors building the future of UI development." }),
              e.jsxs("a", {
          ...
          e.jsxs("div", {
            className: "sb-section-item",
            children: [
              e.jsx("img", { src: g, alt: "Discord logo", className: "sb-explore-image" }),
              e.jsxs("div", {
                children: [
          ...
          e.jsxs("div", {
            className: "sb-section-item",
            children: [
              e.jsx("img", { src: j, alt: "Youtube logo", className: "sb-explore-image" }),
              e.jsxs("div", {
                children: [
          ...
          e.jsxs("div", {
            className: "sb-section-item",
            children: [
              e.jsx("img", { src: f, alt: "A book", className: "sb-explore-image" }),
