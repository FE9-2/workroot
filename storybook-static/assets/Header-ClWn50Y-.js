      ...
      e.createElement(
        ...
        n
          ? e.createElement(
              e.Fragment,
              null,
              e.createElement("span", { className: "welcome" }, "Welcome, ", e.createElement("b", null, n.name), "!"),
              e.createElement(t, { size: "small", onClick: r, label: "Log out" })
            )
          : e.createElement(
              e.Fragment,
              null,
              e.createElement(t, { size: "small", onClick: a, label: "Log in" }),
              e.createElement(t, { primary: !0, size: "small", onClick: l, label: "Sign up" })
            )
      )
    )
  );
