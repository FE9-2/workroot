...
var C = {
  ...
  j = {};
function p(e, t, n) {
  (this.props = e), (this.context = t), (this.refs = j), (this.updater = n || C);
}
...
function I(e, t, n) {
  ...
  return { $$typeof: y, type: e, key: c, ref: s, props: o, _owner: w.current };
}
function G(e, t) {
...
function _(e, t, n, u, o) {
  ...
  if (s)
    return (
      ...
      R(o)
        ? ((n = ""),
          e != null && (n = e.replace(k, "$&/") + "/"),
          _(o, t, n, "", function (a) {
            return a;
          }))
        : o != null &&
          (E(o) && (o = G(o, n + (!o.key || (s && s.key === o.key) ? "" : ("" + o.key).replace(k, "$&/") + "/") + e)),
          t.push(o)),
      1
    );
  if (((s = 0), (u = u === "" ? "." : u + ":"), R(e)))
...
var l = { current: null },
  h = { transition: null },
  K = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: w };
function T() {
...
r.cloneElement = function (e, t, n) {
  ...
  if (t != null) {
    ...
    for (i in t) x.call(t, i) && !P.hasOwnProperty(i) && (u[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
  }
...
var Q = $.exports;
const Y = D(Q);
export { Y as R, X as c, D as g, Q as r };
